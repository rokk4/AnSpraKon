...
help = (
    ...
    '',
    'Options:',
    '-l|--language <language>	Language to speak_text: (default is en-US)',
...
try:
    ...
    try:
        remove(temp)  # The temp file may not have been removed yet
    except OSError:
        pass  # The file doesn't exist and therefore doesn't need to be removed
